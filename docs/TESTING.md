...
- Android Lint：`lintDebug` 成功，0 错误（6 个非阻断警告、1 个提示）
- `assembleDebug`：成功
- 完整命令：`BUILD SUCCESSFUL`，耗时 10 分 36 秒
- APK：`Habit-0.1.0-debug.apk`
- APK 大小：14,594,707 字节（13.92 MiB）
- APK SHA-256：`e0864b02344d8cddff36783561581f80e3e5295b35f585056fe4539430136892`
...
- 备份策略：源清单与打包合并清单的 `android:allowBackup` 均为 `false`，与“仅本机、无备份恢复”产品说明一致。
